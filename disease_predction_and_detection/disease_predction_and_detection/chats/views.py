...
from disease_predction_and_detection.main_app.views import patient_ui, doctor_ui
from disease_predction_and_detection.main_app.models import patient , doctor
